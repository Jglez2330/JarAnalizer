...
public class JarExtractPath {
    ...
    static List<String> listC = new ArrayList<>();
    static List<String> listD = new ArrayList<>();
    static List<String> listJ = new ArrayList<>();
    static List<String> listF = new ArrayList<>();
    ...
    public static List<String> getDependencies (File jar) throws Exception {
